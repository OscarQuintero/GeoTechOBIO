<div
      ...
      ></div>
      <aside
        class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto dark:bg-gray-800 md:hidden"
        x-show="isSideMenuOpen"
        x-transition:enter="transition ease-in-out duration-150"
        ...
        style="background-color: rgba(185,189,147,0.75);"
      >
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              <a
                ...
                href="/ofertas"
              >
                @include('icons.icon-ofertas')
                <span class="ml-4">Ofertas</span>
              </a>
            </li>
             <!-- Categorias -->
            <li class="relative px-6 py-3">
              <a
                ...
                href="/categoriesfull"
              >
                @include('icons.icon-categoriesfull')
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  <!-- Lista de estados -->
                  @include('layouts.estadosbackdrop')
                </ul>
              </template>
            </li>
          </ul>
